...
int width = 6; // ширина рисуемого прямоугольника
int height = 15; // высота рисуемого квадрата
int rows = 15; // количество строк исходной матрицы
int columns = 15; // количество столбцов исходной матрицы

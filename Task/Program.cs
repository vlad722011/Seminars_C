/*
Сделал это просто для себя. Придумал себе задачу и реализовал вот в такой алгоритм.
Это программа, которая преобразует любое натурльное число N (N > 0, N - целое число),
в целлочисленный массив. Сначала программа, используя математические выражения находит длину
числа, и далее создает массив и заполняет его цифрами, из которых состоит исходное число.
*/
